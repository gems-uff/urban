...
public class GeneratingConfigXML {
      ...
      public static void mainGeneratingConfigXML(String colors[][], String linhaIdBus[][]){
          ...
          //agenda.addContent("thiago");
           ...
           //*******************************************************************************
            ...
            while(!ProvenanceMain.linhaIdBus[linhaAtualLinhaIdBus][0].equals("")
               && !ProvenanceMain.linhaIdBus[linhaAtualLinhaIdBus][1].equals(""))
            {
                ...
                attribute2.setText(ProvenanceMain.linhaIdBus[linhaAtualLinhaIdBus][0]);//Linha
                activitycolor.addContent(attribute2);

                //__________________________________________
                Element value = new Element("value");
                value.setText(ProvenanceMain.linhaIdBus[linhaAtualLinhaIdBus][1]);//ID
                ...
                if(linhaAtualLinhaIdBus < ProvenanceMain.MAX_colors)
                {
                    r.setText(ProvenanceMain.colors[linhaAtualLinhaIdBus][0]);
                }else{
                ...
                if(linhaAtualLinhaIdBus < ProvenanceMain.MAX_colors)
                {
                    g.setText(ProvenanceMain.colors[linhaAtualLinhaIdBus][1]);
                }else{
                ...
                if(linhaAtualLinhaIdBus < ProvenanceMain.MAX_colors)
                {
                    b.setText(ProvenanceMain.colors[linhaAtualLinhaIdBus][2]);
                }else{
