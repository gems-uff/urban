 ...
 * @author thiago
 */
public class ProvenanceMainCombined {
    
    //==============THOP0000==============
    //Máximo de pontos no mapa
    public static final int QUANTIDADE_DE_PONTOS = 10000;
    //==============THOP0000==============
    
    
//==============THOP11111==============    
    //Valor da distância entre os pontos que se combinarão, tanto em longitude quanto em latitude
    public static final double raio_aceitavel = 0.01;
    
    public static final int LIN_TabelaDePontos = QUANTIDADE_DE_PONTOS;
    public static final int COL_TabelaDePontos = 5;
    public static double TabelaDePontos[][] = new double[LIN_TabelaDePontos][COL_TabelaDePontos];
    //coluna 0: longitude
    //coluna 1: latitude
    //coluna 2: a média das velocidades médias
    //coluna 3: armazena a quantidade de pontos combinada neste ponto
    //coluna 4: Linha
    //==============THOP11111==============
    ...
    public static GeneratingConfigXMLCombined gConfigXML = new GeneratingConfigXMLCombined();
    public static GeneratingXMLCombined gXML = new GeneratingXMLCombined();
    ...
    public static void main(String[] args) {
        ...
        //Inicializando Tabela de Pontos
        for(i = 0; i < LIN_TabelaDePontos; i++)
        {
            for(j = 0; j < COL_TabelaDePontos; j++)
            {                
                TabelaDePontos[i][j] = 0;                
            }
        }
        ...
        GeneratingXMLCombined.mainGeneratingXML(linhaIdBus);
        GeneratingConfigXMLCombined.mainGeneratingConfigXML(colors, linhaIdBus);
    }
